...
// Hide/reveal header on scroll for distraction-free reading
...
if (siteHeader) {
  ...
  const handleHeader = () => {
    ...
    const hideHeader = scrollingDown && currentY > 120;

    siteHeader.classList.toggle('is-hidden', hideHeader);
    siteHeader.classList.toggle('is-compact', currentY > 20);
