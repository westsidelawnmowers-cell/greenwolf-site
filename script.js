...
const readMoreButtons = document.querySelectorAll('.option-read-more');
...
readMoreButtons.forEach((button) => {
  ...
  button.addEventListener('click', () => {
    ...
    const willOpen = card.classList.toggle('is-open');
    description.hidden = !willOpen;
    button.textContent = willOpen ? 'Hide details' : 'Read more';
